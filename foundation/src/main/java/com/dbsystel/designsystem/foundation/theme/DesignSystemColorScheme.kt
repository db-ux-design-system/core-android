...
class AdaptiveColors private constructor(
	...
	val bgBasicTransparentHovered: Color,
	val bgBasicTransparentPressed: Color,
	...
	val onBgBasicEmphasis60Hovered: Color,
	val onBgBasicEmphasis60Pressed: Color,
	val onBgBasicEmphasis50Default: Color,
	val onBgBasicEmphasis50Hovered: Color,
	val onBgBasicEmphasis50Pressed: Color,
	...
	internal companion object {
		...
		fun light(colorMap: Map<String, Color>, colorName: String) = AdaptiveColors(
			...
			colorMap.getValue(colorName + 6).copy(0.84f),
...
class DesignSystemColorScheme(
	val neutral: AdaptiveColors,
	val brand: AdaptiveColors,
	val informational: AdaptiveColors,
	val warning: AdaptiveColors,
	val successful: AdaptiveColors,
	val critical: AdaptiveColors,
	val yellow: AdaptiveColors,
	val orange: AdaptiveColors,
	val red: AdaptiveColors,
	val pink: AdaptiveColors,
	val violet: AdaptiveColors,
	val blue: AdaptiveColors,
	val cyan: AdaptiveColors,
	val turquoise: AdaptiveColors,
...
internal fun getColorSchemeDark(colorMap: Map<String, Color>): DesignSystemColorScheme =
	DesignSystemColorScheme(
		...
		informational = AdaptiveColors.dark(colorMap, "informational"),
		warning = AdaptiveColors.dark(colorMap, "warning"),
		successful = AdaptiveColors.dark(colorMap, "successful"),
		critical = AdaptiveColors.dark(colorMap, "critical"),
		yellow = AdaptiveColors.dark(colorMap, "yellow"),
		orange = AdaptiveColors.dark(colorMap, "orange"),
		red = AdaptiveColors.dark(colorMap, "red"),
		pink = AdaptiveColors.dark(colorMap, "pink"),
		violet = AdaptiveColors.dark(colorMap, "violet"),
		blue = AdaptiveColors.dark(colorMap, "blue"),
		cyan = AdaptiveColors.dark(colorMap, "cyan"),
		turquoise = AdaptiveColors.dark(colorMap, "turquoise"),
...
internal fun getColorSchemeLight(colorMap: Map<String, Color>): DesignSystemColorScheme =
	DesignSystemColorScheme(
		...
		informational = AdaptiveColors.light(colorMap, "informational"),
		warning = AdaptiveColors.light(colorMap, "warning"),
		successful = AdaptiveColors.light(colorMap, "successful"),
		critical = AdaptiveColors.light(colorMap, "critical"),
		yellow = AdaptiveColors.light(colorMap, "yellow"),
		orange = AdaptiveColors.light(colorMap, "orange"),
		red = AdaptiveColors.light(colorMap, "red"),
		pink = AdaptiveColors.light(colorMap, "pink"),
		violet = AdaptiveColors.light(colorMap, "violet"),
		blue = AdaptiveColors.light(colorMap, "blue"),
		cyan = AdaptiveColors.light(colorMap, "cyan"),
		turquoise = AdaptiveColors.light(colorMap, "turquoise"),
		green = AdaptiveColors.light(colorMap, "green"),
	)

val LocalColors = staticCompositionLocalOf { getColorSchemeLight(DeutscheBahnColorMap) }
val LocalActiveColor =
	staticCompositionLocalOf { getColorSchemeLight(DeutscheBahnColorMap).neutral }
